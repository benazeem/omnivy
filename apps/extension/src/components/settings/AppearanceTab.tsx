...
const AppearanceTab = ({ uiState, dispatch }: AppearanceTabProps) => {
  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-right-8 duration-500 max-w-5xl">
      <header>
      ...
      <section className="glass-panel p-10 space-y-8">
        ...
        <div className="space-y-10">
          <div>
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-brand-600 mb-6 block">
              Interface Theme
            </label>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {themeOptions.map((opt) => (
                <Button
                  ...
                  className={`relative p-5 rounded-3xl text-left transition-all duration-300 border-2 group overflow-hidden ${
                ...
                >
                  <div
                    className="w-full h-20 rounded-2xl mb-4 border border-black/5 flex flex-col p-3 gap-2"
              ...
              {fontFamilyOptions.map((opt) => (
                ...
                >
                  <div className="flex flex-col items-start">
                    <span className={`text-sm font-black ${opt.class}`}>
                      {opt.label}
                    </span>
                    <span
                      className={`text-[10px] text-[var(--text-muted)] ${opt.class}`}
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {densityOptions.map((opt) => (
              <Button
                ...
                className={`p-6 rounded-3xl transition-all duration-300 border-2 text-left ${
                  uiState.uiDensity === opt.value
                    ? 'border-brand-600 bg-brand-600/10 shadow-lg'
                    : 'border-[var(--border-dim)] bg-[var(--bg-muted)]/30 hover:border-brand-500/40'
                }`}
              >
                <p className="font-black text-sm uppercase tracking-wider mb-2">
                  {opt.label}
                </p>
      ...
      <section className="glass-panel p-10 space-y-8 bg-brand-600/5 border-brand-600/20">
        <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="glass-panel p-5 flex items-center justify-between group cursor-pointer hover:border-brand-500 transition-all">
                <div className="flex items-center gap-3">
